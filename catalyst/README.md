...
No Route Handlers read this data yet - see §5.
...
## 5. Next
- Build Route Handlers to read the NoSQL collections (§2b) and wire them
  into the investigation workspace / features.md functionality.
...
- Extend live data to case files / investigation board using the now-seeded
  NoSQL data.
